...
<DockerSpinup
  kickstartUri={frontmatter.codeRoot + "/kickstart/kickstart.json"}
/>
...
<RemoteCode
  url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/main.tsx"
  lang="tsx"
/>
...
<RemoteCode
  url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/pages/HomePage.tsx"
  lang="tsx"
/>

#### Create an Account Page

The account page will be a simple page that displays an input field for the user to enter a dollar amount and a button to convert that amount into coins. Create a new file `src/pages/AccountPage.tsx`:

<RemoteCode
  url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/pages/AccountPage.tsx"
  lang="tsx"
/>
...
<RemoteCode
  url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/components/LogoHeader.tsx"
  lang="tsx"
/>
...
<RemoteCode
  url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/components/MenuBar.tsx"
  lang="tsx"
/>
...
<RemoteCode
  url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/App.tsx"
  lang="tsx"
/>
...
<Aside type="note">
  The username and password of the `example user` can be found in the{" "}
  <a href="#run-fusionauth-via-docker">FusionAuth via Docker</a> section at the
  top of this article.
</Aside>
...
<NextSteps>
  <Fragment slot="security">
    <li>
      You can use the hosted backend pages to run this example without your own
      OAuth backend, but [review the hosted backend
      docs](/docs/apis/hosted-backend) to be aware of the limitations of this
      approach.
    </li>
  </Fragment>
</NextSteps>
